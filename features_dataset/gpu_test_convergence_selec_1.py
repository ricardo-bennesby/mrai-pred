...
list_peers = [0,6,7,9,10,11,12,13,14,16,17,18,19]
list_peers = [9,10,11,12,13,14,16,17,18,19]
#list_peers = [9,10,11,12,13,14,16,17,18,19]
...
#TEST 09:
#day_list = ["03-09","04-09","05-09","06-09","07-09","09-09","10-09","11-09","13-09","15-09","16-09","18-09","20-09","22-09","23-09","24-09","25-09","26-09","27-09","28-09","30-09"]
...
#TEST 10
#day_list = ["02-10","07-10","09-10","10-10","11-10","13-10","14-10","15-10","16-10","17-10","18-10","20-10","21-10","22-10","23-10","24-10","25-10","26-10","27-10","28-10","29-10","30-10","31-10"]
...
for day in day_list:
	...
	for peer_id_index in range(0,len(list_peers)):
		...
		test_dataset = read_csv('test-timestamps-'+day+"-"+peers_list[peer_id]+'.csv')
		test_values = test_dataset.values
		num_timestamps = (len(test_values))/((num_events*test_num_days))
		#print("num_timestamps:")
		#print(num_timestamps)

		test_dataset_y = read_csv('test-times_after-'+day+"-"+peers_list[peer_id]+'.csv')
		...
		for num_event in range(0,num_events*test_num_days):
			...
			test_list.append(test_values[int(start_index):int(start_index+num_timestamps)])
		...
		for x in range(0,test_num_days):
			current_index = last_index
			last_index = current_index
			for j in range(0,int(len(base_time)/2)):
				#print("j*2: "+str(j*2))
	...
	for num_event in range(0,int(num_events/2)):
		ct_list = []
		#print("\n")
