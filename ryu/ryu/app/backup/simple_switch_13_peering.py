		    ...
		    #	self.logger.info("self.remaining_buffer: %s",self.remaining_buffer_type)
				...
				if self.bgp_total_path_att_len> 0:
					...
					if pathAtt[2] == 0:
						...
						if len(self.accepted_prefixes_set) > 753000:
                        ...
                        if (int(totalpathattlen2[0])) > 0:
							...
							if pathAtt[2] == 0:
								...
								if has_destination == 1:
									...
									msg = "neighbor 100.78.128.1 announce route 184.164.226.0/24 next-hop self origin egp as-path [ " + str_as_list +"]"
									self.logger.info("msg: %s",msg)

									str_as_list2 = ""
									for i in range(0,len_ases-1):
										str_as_list2 = str_as_list2 + "47065 "
									msg2 = "neighbor 100.78.128.1 announce route 184.164.226.0/24 next-hop self origin egp as-path [ " + str_as_list2 +"]"
