...
peering_ip = '100.78.128.5'
#remote_controller_ip = '192.168.1.112' 
...
if __name__ == '__main__':
    ...
    root = net.addHost( 'root', inNamespace=False, ip='192.168.1.122/24' )
    ...
    root.setIP('192.168.1.122/24', intf='root-eth0')
    bgp.setIP('192.168.1.120', intf='bgp-eth1')
