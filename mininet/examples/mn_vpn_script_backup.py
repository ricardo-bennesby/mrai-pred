...
if __name__ == '__main__':
    ...
    #net = Mininet( topo=topo, switch=CustomSwitch, controller=partial( RemoteController, ip='192.168.0.113', port=6633  ))
    net = Mininet( topo=topo, switch=OVSSwitch, controller=partial( RemoteController, ip='192.168.0.113', port=6633  ))
    ...
    bgp = net.addHost( 'bgp', ip="100.69.128.9" )
    ...
    bgp.setIP('100.69.128.9', intf='bgp-eth0')
    #bgp.cmdPrint( 'ifconfig bgp-eth0 192.168.0.110' ) 
    #bgp.cmdPrint( 'ifconfig bgp-eth1 100.69.128.5' )
    #root.cmdPrint( 'ifconfig root-eth0 192.168.0.112' )
    #bgp.cmdPrint( 'ifconfig bgp-eth0 192.0.1.110' )
    #bgp.cmdPrint( 'ifconfig bgp-eth1 192.168.1.110' )
    #root.cmdPrint( 'ifconfig root-eth0 192.168.1.112' )
    #root.cmdPrint( 'sysctl -w net.ipv4.conf.all.forwarding=1' )
    #bgp.cmdPrint( 'sysctl -w net.ipv4.conf.all.forwarding=1' )
    #bgp.cmdPrint( 'sudo iptables -A INPUT -p tcp --sport 179 -j ACCEPT' )
    #bgp.cmdPrint( 'sudo iptables -A INPUT -p tcp --dport 179 -j ACCEPT' )
    #s1.cmdPrint( 'sysctl -w net.ipv4.conf.all.forwarding=1' )
